...
[
 ...
 ```
The important field is set in ```country_code```, where the exact place of interest -- or zone -- for data collection is set. Visit the [CO2signal website](https://api.electricitymap.org/v3/zones) to check all available zones as of today.
