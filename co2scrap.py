...
#    DISCLAIMER:
#
#    Any data collected in here is the exclusive property of ElectricityMap and/or related parties. 
#    If in doubt about rights to use this data, please visit https://www.electricitymaps.com/contact-us
#
# -- END OF DISCLAIMER --
...
def exec_zones(output_dir, sleep=5.0):
    ...
    for zone in zones:
        if first_zone == True:
            ...
            logger.info('Sleeping for {}s before issuing a new request...'.format(sleep))
            time.sleep(sleep)
...
def serve():
    ...
    parser.add_argument("--country-zone", dest="country", type=str, nargs='+', help="Country Zone Name. Do not use it with --regions-file.")
    ...
    parser.add_argument("--api_url", dest="api_url", type=str, default="https://api.co2signal.com/v1/latest",
                        help="co2signal.com API URL (in case the default URL has been changed)")
    parser.add_argument("--sleep", dest="sleep", type=float, default=3.0, help="Sleep time (in seconds) between multiple API request calls")
